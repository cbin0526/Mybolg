...
<div id="header">
     ...
     <div id="Regis_mainbox">
        <p class="title">个人博客注册 </p>
     		<div class="left">
            	<form id="form2" method="get" action="DoRegister">
            	<div class="cont">
            		<p>登录账号：<input type="text" name="username" id="textfield2" class="input_sty" /><span></span></p>
            		<p>设置密码：<input type="text" name="userpwd" id="textfield2" class="input_sty" /><span></span></p>
                    <p>确认密码：<input type="text" name="repwd" id="textfield2" class="input_sty" /><span></span></p>
          		 	<p>用户角色：<input type="text" name="userjob" id="textfield2" class="input_sty" /><span></span></p>
          		 	<p>个人描述：<input type="text" name="userinfo" id="textfield2" class="input_sty" /><span></span></p>
 	                <p>个人头像：<input type="file" name="userlogo">
                    <p class="zc_but"><input type="submit"  value="注 册" /></p>
