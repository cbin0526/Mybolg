...
<!--right-->
         <div class="right" id="c_right">
          ...
          <h2>关于博主</h2>
           ...
           <p>博主：${sessionScope.loginuser.user_name } </p>
           <p>职业：${sessionScope.loginuser.user_job }</p>
           <p>简介：${sessionScope.loginuser.user_info }</p>
           <p><a href="javascript:loginout()">注销用户</a></p>
